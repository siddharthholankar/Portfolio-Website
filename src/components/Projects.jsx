      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Real-world financial analysis projects delivering measurable business impact
          </p>
        </div>
          ...
          {projects.slice(0, visibleProjects).map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {project.impact && (
                  <div className="flex items-center justify-center space-x-2 bg-green-50 border border-green-200 rounded-lg px-3 py-2">
                    <svg
